  ...
  return (
    <div className="space-y-8 p-4 sm:p-6 lg:p-8 bg-white min-h-full">
      ...
      <div className="p-6 rounded-xl" style={{ backgroundColor: "#E8BF31" }}>
        ...
        <p className="text-4xl font-extrabold text-yellow-900 mt-1">₦0.00</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <ToDoCard
          ...
          onClick={() => console.log("Sponsor Review Placeholder")}
        />
      </div>
      ...
      {/* Suggested For You */}
      <h2 className="text-sm text-gray-500 font-medium pt-4">
        Suggested For You
      </h2>
