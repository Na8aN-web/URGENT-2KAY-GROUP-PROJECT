  ...
  return (
    <div className="p-5 sm:p-6 lg:p-8 bg-[#ECE8F0] min-h-screen">
      <div className="flex flex-col items-center justify-center pt-16 sm:pt-22">
        ...
        <p className="pb-4 text-[#545050] text-base sm:text-lg font-bold">
          Oops! It Seems Like you Haven't Created Any Relationship Yet 
        </p>

        <Button btnTxt="Create a relationship" onClick={onNext} />
      </div>
    </div>
  );
};
